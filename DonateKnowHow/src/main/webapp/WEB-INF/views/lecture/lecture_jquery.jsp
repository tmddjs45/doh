...
<body>
	<%@include file= "../includes/header.jsp" %>
			...
			<div class="sideMenubar">
				...
				<c:forEach items="${lectureList}" var="list">
							<li><a class="sideBtn" href="${path}/lecture/content?lecture_no=${list.lecture_no}&lecture_name=lecture_jquery">${list.lecture_title}</a></li><!-- 이 부분을 강좌마다 바꾸면 됩니다 -->						
				</c:forEach>
			...
			<div id="main">
				<c:choose>
					<c:when test="${command != null }">
						...
						<div class="align">
							<form name="writeForm">
								<input type="hidden" name="lecture_name" value="lecture_jquery"/>	<!-- 강좌마다 이 부분 바꿔주면 됩니다 -->
	...
	<script>
		...
		function makeLecture(){
			...
			sideMenuForm.lecture_name.value = "lecture_jquery"; <%-- 이 부분을 강좌마다 바꾸셔야합니다 --%>
