...
<title>LIST</title>
	...
	<table border='1' width='600' align='center' cellpadding='2'>
		...
		<th align='center' width='15%'>NICNAME</th>
	...
	<c:forEach items="${list}" var="qboard">	
		<tr>
		<td align='center'><c:out value='${qboard.qno}'/></td>
		<td><c:out value='${qboard.nicname}'/></td>
		<td><c:out value='${qboard.email}'/></td>
		<td><a href='Qcontent?qno=<c:out value='${qboard.qno}'/>'><c:out value='${qboard.q_title}'/></a></td>
		<td><c:out value='${qboard.q_date}'/></td>
