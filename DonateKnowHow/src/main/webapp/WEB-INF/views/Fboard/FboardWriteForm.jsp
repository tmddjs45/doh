...
<body>
		...
		<div class="content">
			...
			<!-- 임시로 세션으로 줘야할 값을 무작정 넣었습니다... 나중에 잊지 말고 수정하십시오 장현! 바로 너!!! -->
				<table class="write-table">
					<tr>
						<td><input type="text" name="f_title" placeholder="제목을 입력해주세요"></td>
					</tr>
					<tr>
						<td><textarea id="f_content" name="f_content"></textarea></td>
					</tr>
					<tr>
				...
				<button type="button" class="btn" onclick="writeButton()">등록</button>
				</div>
			</form>
		</div>
		<div></div>
	...
	<script type="text/javascript">
		...
		function writeButton() {
			...
			var f_title = writeForm.f_title.value;
			var f_content = writeForm.f_content.value;
			console.log(f_title);
			console.log(f_content);
			if(f_title == "" || f_title.length == 0){
			}else{
				writeForm.method = "post";
				writeForm.action = "/fboard/write";
				writeForm.submit();
			}
		}
	</script>
