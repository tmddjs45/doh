...
<div class="wrapper">
	...
	<div class="content">
        ...
        <p>우리는 기부를 할 것입니다. 우리들의 노하우를 말이죠.</p>
    	...
    	<div style="border-top: 1px solid black; border-bottom: 1px solid black;">
    		<p style="text-align: left;">
    			...
    			<u>정보는 많았지만 무질서했고, 나에게는 불필요한 정보들도 있었죠.</u> 어려움이 많았어요.
    		</p>
    		...
    		<p style="text-align: left;">
    			우리가 함께 만들어 나갈 이 웹 페이지가 오늘날 같은 '<u>오픈소스</u>' 시대에 <u>드넓은 정보의 '바다' 안에서</u> 
    			우리들의 지식들을, 우리들의 노하우들을 다른 사람들에게도 쉽게 전할 수 있는 '<u>돛단배</u>'가 되었으면 하는 바람입니다.
    			더 큰 배면 좋구요. 히히 :)
    		</p>
