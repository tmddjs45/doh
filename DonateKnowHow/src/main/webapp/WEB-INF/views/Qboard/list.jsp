...
<title>LIST</title>
	...
	<c:forEach items="${list}" var="qboard">	
		<table id='qtable' border='1' width='600' align='center'>
			...
			<tr>
				...
				<tr>
					<td><a href="content${cr.makeQuery(cr.num)}&q_no=${qboard.q_no}">Q_no :: <c:out value='${qboard.q_no}'/></td>
				</tr>
			</tr>
		</table>
	</c:forEach>	
	...
	<div align='center'>
			<c:if test='${cr.pre}'>
			<a href='list${cr.makeQuery(cr.pageStart-1)}'>
			...
			<c:if test='${cr.next}'>
				<a href='list${cr.makeQuery(cr.pageEnd+1)}'>
